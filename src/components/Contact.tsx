            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Emergency: +91-98191916886<br />
                    Office: +91-98191916886<br />
                    Volunteer: +91-98191916886
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    General: xxx@gmail.com<br />
                    Emergency:xxx@gmail.com<br />
                    Donations: xxx@gmail.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Monday - Friday: x:00 AM - x:00 PM<br />
                    Saturday: x:00 AM - x:00 PM<br />
